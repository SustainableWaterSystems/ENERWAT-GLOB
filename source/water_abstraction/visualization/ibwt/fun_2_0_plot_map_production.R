...
p.map.production.segments <- ggplot() +
  ...
  scale_size_continuous(name = 'Mean energy production (TWh y<sup>-1</sup>)',
                        range=c(2,6)) +
  scale_fill_gradient(low='#44AA99', high='#E3A43E', name = 'Production intensity (m<sup>3</sup> kwh<sup>-1</sup>)') +
...
production.z1 <- ggplot()+
  ...
  scale_size_continuous(name = 'Mean energy production (TWh y<sup>-1</sup>)',
                        breaks=c(1,3,5,7,10),
                        range=c(2,6)) +
  scale_fill_gradient(low='#44AA99', high='#E3A43E', name = 'Production intensity (kwh m<sup>-3</sup>)') +
  theme(legend.position = 'none',
