...
correction.factors <- read.csv(
  paste0(outputDirData, '1_0_bias_correction_sections.csv'))
...
####save####
write.csv(discharge.monthly.cut, paste0(outputDirData, '2_0_discharge_bias_corrected_monthly.csv'), row.names = F)
write.csv(discharge.yearly.cut, paste0(outputDirData, '2_1_discharge_bias_corrected_yearly.csv'), row.names = F)
